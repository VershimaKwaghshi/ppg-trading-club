...
{NAV_LINKS.map(l => (
<a key={l.label} href={l.href} style={{ color: “#b0a080”, fontSize: 14, fontFamily: “‘DM Sans’, sans-serif”, textDecoration: “none”, fontWeight: 500, letterSpacing: “0.03em”, transition: “color 0.2s” }}
onMouseEnter={e => e.target.style.color = “#c4a050”}
onMouseLeave={e => e.target.style.color = “#b0a080”}>{l.label}</a>
))}
...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=DM+Sans:wght@300;400;500;700&family=DM+Mono:wght@400;500&display=swap'); * { box-sizing: border-box; margin: 0; padding: 0; } body { background: #050814; } ::-webkit-scrollbar { width: 6px; } ::-webkit-scrollbar-track { background: #050814; } ::-webkit-scrollbar-thumb { background: #c4a050; border-radius: 3px; } @media (max-width: 768px) { .desktop-nav { display: none !important; } }`}</style>
</nav>
);
}
...
```
  <div style={{ textAlign: "center", maxWidth: 900, padding: "0 2rem", position: "relative", zIndex: 2 }}>
    ...
    <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
      <a href="#register" style={{ background: "linear-gradient(135deg,#c4a050,#f0d080)", color: "#050814", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 15, padding: "16px 36px", borderRadius: 8, textDecoration: "none", letterSpacing: "0.03em", boxShadow: "0 8px 32px rgba(196,160,80,0.35)", transition: "transform 0.2s, box-shadow 0.2s" }}
        onMouseEnter={e => { e.target.style.transform = "translateY(-2px)"; e.target.style.boxShadow = "0 12px 40px rgba(196,160,80,0.5)"; }}
        onMouseLeave={e => { e.target.style.transform = ""; e.target.style.boxShadow = "0 8px 32px rgba(196,160,80,0.35)"; }}>
        Join the Club — $4.99/Mo
      </a>
      <a href="#how" style={{ border: "1px solid rgba(196,160,80,0.35)", color: "#c4a050", fontFamily: "'DM Sans', sans-serif", fontWeight: 600, fontSize: 15, padding: "16px 36px", borderRadius: 8, textDecoration: "none", background: "transparent", transition: "all 0.2s" }}
        onMouseEnter={e => { e.target.style.background = "rgba(196,160,80,0.08)"; }}
    ...
    <div style={{ display: "flex", gap: 0, justifyContent: "center", marginTop: 80, flexWrap: "wrap", borderTop: "1px solid rgba(196,160,80,0.1)", paddingTop: 48 }}>
      {[["$100", "Minimum Deposit"], ["7", "Risk Tiers"], ["24H", "Withdrawals"], ["15%", "Referral Earn"]].map(([val, lbl], i) => (
        <div key={i} style={{ padding: "0 40px", borderRight: i < 3 ? "1px solid rgba(196,160,80,0.1)" : "none", textAlign: "center" }}>
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "2rem", fontWeight: 900, color: "#c4a050" }}>{val}</div>
          <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#606080", marginTop: 4, letterSpacing: "0.08em", textTransform: "uppercase" }}>{lbl}</div>
        </div>
      ))}
    </div>
  </div>
...
Penny Partners Group —<br /><em style={{ color: “#c4a050”, fontStyle: “italic” }}>Built on Trust</em>
</h2>
<p style={{ fontFamily: “‘DM Sans’, sans-serif”, color: “#7878a0”, lineHeight: 1.9, fontSize: 16, marginBottom: 20 }}>
We are <strong style={{ color: “#c4a050” }}>Penny Partners Group (PPG Solutions)</strong>, a CAC-registered Nigerian financial cooperative built with one mission: to help everyday people access professional-grade forex trading and build real, sustainable wealth — together.
</p>
...
<div key={i} style={{ background: “rgba(255,255,255,0.02)”, border: “1px solid rgba(196,160,80,0.1)”, borderRadius: 12, padding: “24px 20px”, transition: “border-color 0.3s, background 0.3s” }}
onMouseEnter={e => { e.currentTarget.style.borderColor = “rgba(196,160,80,0.35)”; e.currentTarget.style.background = “rgba(196,160,80,0.05)”; }}
onMouseLeave={e => { e.currentTarget.style.borderColor = “rgba(196,160,80,0.1)”; e.currentTarget.style.background = “rgba(255,255,255,0.02)”; }}>
...
function HowItWorks() {
return (
<section id=“how” style={{ padding: “120px 2rem”, background: “#050814”, position: “relative”, overflow: “hidden” }}>
<div style={{ position: “absolute”, top: “50%”, left: “50%”, transform: “translate(-50%,-50%)”, width: 600, height: 600, background: “radial-gradient(circle, rgba(196,160,80,0.04) 0%, transparent 70%)”, borderRadius: “50%”, pointerEvents: “none” }} />
...
<h2 style={{ fontFamily: “‘Playfair Display’, serif”, fontSize: “clamp(2rem, 4vw, 3rem)”, fontWeight: 900, color: “#f0e8d0”, lineHeight: 1.2 }}>
How It <em style={{ color: “#c4a050” }}>Works</em>
</h2>
...
<div style={{ background: “rgba(255,255,255,0.02)”, border: “1px solid rgba(196,160,80,0.1)”, borderRadius: 16, padding: “32px 28px”, height: “100%”, transition: “all 0.3s” }}
onMouseEnter={e => { e.currentTarget.style.borderColor = “rgba(196,160,80,0.3)”; e.currentTarget.style.background = “rgba(196,160,80,0.04)”; e.currentTarget.style.transform = “translateY(-4px)”; }}
onMouseLeave={e => { e.currentTarget.style.borderColor = “rgba(196,160,80,0.1)”; e.currentTarget.style.background = “rgba(255,255,255,0.02)”; e.currentTarget.style.transform = “”; }}>
...
<h2 style={{ fontFamily: “‘Playfair Display’, serif”, fontSize: “clamp(2rem, 4vw, 3rem)”, fontWeight: 900, color: “#f0e8d0”, lineHeight: 1.2 }}>
Select Your <em style={{ color: “#c4a050” }}>Risk Tier</em>
</h2>
<p style={{ fontFamily: “‘DM Sans’, sans-serif”, color: “#7878a0”, marginTop: 16, fontSize: 16, maxWidth: 600, margin: “16px auto 0” }}>
You choose your risk tolerance. Your assigned manager follows it exactly. Higher potential means higher risk — choose honestly, not ambitiously.
</p>
</div>
</AnimatedSection>
...
style={{
background: selected === i ? `rgba(${tier.color === "#fbbf24" ? "196,160,80" : "255,255,255"},0.06)` : “rgba(255,255,255,0.02)”,
border: `1px solid ${selected === i ? tier.color : "rgba(196,160,80,0.1)"}`,
borderRadius: 14, padding: “28px 24px”, cursor: “pointer”, transition: “all 0.3s”, position: “relative”, overflow: “hidden”,
boxShadow: selected === i ? `0 0 30px ${tier.color}22` : “none”,
}}
onMouseEnter={e => { if (selected !== i) { e.currentTarget.style.borderColor = `${tier.color}66`; e.currentTarget.style.transform = “translateY(-3px)”; } }}
onMouseLeave={e => { if (selected !== i) { e.currentTarget.style.borderColor = “rgba(196,160,80,0.1)”; e.currentTarget.style.transform = “”; } }}>
{tier.badge && (
...
<strong style={{ color: “#f0e8d0” }}>Risk Warning:</strong> All percentage figures are potential daily targets — they are <strong style={{ color: “#f0d060” }}>not guaranteed returns</strong>. Forex trading involves substantial risk of loss. You may lose some or all of your invested capital. Past performance is not indicative of future results. Never invest money you cannot afford to lose.
</p>
</div>
</AnimatedSection>
</div>
...
<h2 style={{ fontFamily: “‘Playfair Display’, serif”, fontSize: “clamp(2rem, 4vw, 3rem)”, fontWeight: 900, color: “#f0e8d0”, lineHeight: 1.2 }}>
Simple, <em style={{ color: “#c4a050” }}>Honest Fees</em>
</h2>
<p style={{ fontFamily: “‘DM Sans’, sans-serif”, color: “#7878a0”, marginTop: 16, fontSize: 16, maxWidth: 520, margin: “16px auto 0” }}>
No hidden charges. What you see is what you pay. Every fee is disclosed upfront.
</p>
</div>
</AnimatedSection>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: "flex", gap: 0, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 10, padding: 4, width: "fit-content", marginBottom: 28 }}>
          {["Using Our Recommended Broker", "Using Your Own Broker"].map((t, i) => (
            <button key={i} onClick={() => setTab(i)} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 600, padding: "10px 22px", borderRadius: 7, border: "none", cursor: "pointer", transition: "all 0.25s", background: tab === i ? "linear-gradient(135deg,#c4a050,#f0d080)" : "transparent", color: tab === i ? "#050814" : "#7878a0" }}>{t}</button>
          ))}
        </div>
            ...
            {[
              ...
              <div key={i} style={{ background: "rgba(196,160,80,0.05)", border: "1px solid rgba(196,160,80,0.2)", borderRadius: 12, padding: "24px 20px" }}>
                ...
                {item.trader ? (
                  ...
                  <div>
                    <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", fontWeight: 900, color: "#c4a050" }}>{item.value}</div>
                    {item.note && <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#606080", marginTop: 4 }}>{item.note}</div>}
                  </div>
                )}
              </div>
            ))}
            <div style={{ background: "rgba(74,222,128,0.05)", border: "1px solid rgba(74,222,128,0.2)", borderRadius: 12, padding: "24px 20px" }}>
              <div style={{ fontSize: 24, marginBottom: 12 }}>✅</div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#7878a0", marginBottom: 8 }}>Why Choose This</div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#4ade80", fontWeight: 600 }}>Better split. Lower fees.</div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#606080", marginTop: 4 }}>You keep more of your profit when you use our vetted broker.</div>
            </div>
          </div>
        ) : (
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(196,160,80,0.1)", borderRadius: 12, padding: "24px 20px" }}>
                ...
                {item.trader ? (
                  ...
                  <div>
                    <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", fontWeight: 900, color: "#f0d080" }}>{item.value}</div>
                    {item.note && <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#606080", marginTop: 4 }}>{item.note}</div>}
                  </div>
                )}
              </div>
            ))}
            <div style={{ background: "rgba(196,160,80,0.04)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 12, padding: "24px 20px" }}>
              <div style={{ fontSize: 24, marginBottom: 12 }}>ℹ️</div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#7878a0", marginBottom: 8 }}>Tip</div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#9090b0", lineHeight: 1.65 }}>Switch to our recommended broker to enjoy a better profit split and lower fees.</div>
            </div>
          </div>
        )}
      </div>
...
function Referral() {
return (
<section id=“referral” style={{ padding: “120px 2rem”, background: “#070a1a”, position: “relative”, overflow: “hidden” }}>
<div style={{ position: “absolute”, bottom: 0, right: 0, width: 500, height: 500, background: “radial-gradient(circle, rgba(196,160,80,0.06) 0%, transparent 70%)”, borderRadius: “50%”, filter: “blur(40px)”, pointerEvents: “none” }} />
<div style={{ maxWidth: 1100, margin: “0 auto”, position: “relative”, zIndex: 1 }}>
<div style={{ display: “grid”, gridTemplateColumns: “1fr 1fr”, gap: 80, alignItems: “center” }}>
<AnimatedSection>
...
<h2 style={{ fontFamily: “‘Playfair Display’, serif”, fontSize: “clamp(2rem, 4vw, 3rem)”, fontWeight: 900, color: “#f0e8d0”, lineHeight: 1.2, marginBottom: 24 }}>
Refer & Earn —<br /><em style={{ color: “#c4a050” }}>Every Time They Do</em>
</h2>
<p style={{ fontFamily: “‘DM Sans’, sans-serif”, color: “#7878a0”, lineHeight: 1.9, fontSize: 16, marginBottom: 20 }}>
Every member receives a unique referral ID. When someone you refer makes a withdrawal, you automatically earn <strong style={{ color: “#c4a050” }}>15% of their gross withdrawal</strong>. This is funded by the withdrawal fee structure — not taken extra from them.
</p>
<p style={{ fontFamily: “‘DM Sans’, sans-serif”, color: “#7878a0”, lineHeight: 1.9, fontSize: 16, marginBottom: 32 }}>
...
const inputStyle = { width: “100%”, background: “rgba(255,255,255,0.04)”, border: “1px solid rgba(196,160,80,0.2)”, borderRadius: 8, padding: “14px 16px”, color: “#f0e8d0”, fontFamily: “‘DM Sans’, sans-serif”, fontSize: 14, outline: “none”, transition: “border-color 0.2s” };
...
<h2 style={{ fontFamily: “‘Playfair Display’, serif”, fontSize: “clamp(2rem, 4vw, 3rem)”, fontWeight: 900, color: “#f0e8d0”, lineHeight: 1.2 }}>Start Your <em style={{ color: “#c4a050” }}>Application</em></h2>
<p style={{ fontFamily: “‘DM Sans’, sans-serif”, color: “#7878a0”, marginTop: 16, fontSize: 15 }}>Membership is limited. Referral ID from an existing member is required.</p>
</div>
</AnimatedSection>
<AnimatedSection delay={0.1}>
...
onFocus={e => e.target.style.borderColor = “#c4a050”} onBlur={e => e.target.style.borderColor = “rgba(196,160,80,0.2)”} />
</div>
<div>
...
style={{ width: “100%”, background: “linear-gradient(135deg,#c4a050,#f0d080)”, color: “#050814”, fontFamily: “‘DM Sans’, sans-serif”, fontWeight: 700, fontSize: 15, padding: “16px”, borderRadius: 10, border: “none”, cursor: “pointer”, letterSpacing: “0.04em”, transition: “opacity 0.2s”, opacity: (form.name && form.email && form.referral && form.consent) ? 1 : 0.5 }}>
Submit Application →
</button>
...
{ title: “Support”, links: [“WhatsApp Support”, “Email Us”, “PPG Solutions”] },
].map((col, i) => (
<div key={i}>
...
{col.links.map(l => (
<a key={l} href=”#” style={{ fontFamily: “‘DM Sans’, sans-serif”, fontSize: 14, color: “#505070”, textDecoration: “none”, transition: “color 0.2s” }}
onMouseEnter={e => e.target.style.color = “#c4a050”} onMouseLeave={e => e.target.style.color = “#505070”}>{l}</a>
))}
</div>
</div>
))}
...
<div style={{ fontFamily: “‘DM Sans’, sans-serif”, fontSize: 12, color: “#404060”, maxWidth: 500 }}>⚠️ Forex trading involves substantial risk. You may lose all your invested capital. PPG Trading Club does not guarantee any returns.</div>
</div>
</div>
</footer>
);
...
<Footer />
{/* WhatsApp FAB */}
<a href=“https://wa.me/2348130500659” target=”_blank” rel=“noreferrer” style={{ position: “fixed”, bottom: 28, right: 28, width: 54, height: 54, background: “#25D366”, borderRadius: “50%”, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: 26, boxShadow: “0 4px 20px rgba(37,211,102,0.4)”, textDecoration: “none”, zIndex: 200, transition: “transform 0.2s” }}
