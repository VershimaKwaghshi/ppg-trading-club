...
var inputStyle = { width: “100%”, background: “rgba(255,255,255,0.04)”, border: “1px solid rgba(196,160,80,0.2)”, borderRadius: 8, padding: “14px 16px”, color: “#f0e8d0”, fontFamily: “‘DM Sans’, sans-serif”, fontSize: 14, outline: “none” };
return (
...
{[“Using Our Recommended Broker”, “Using Your Own Broker”].map(function(t, i) {
return (
<button key={i} onClick={function() { setTab(i); }} style={{ fontFamily: “‘DM Sans’, sans-serif”, fontSize: 13, fontWeight: 600, padding: “10px 22px”, borderRadius: 7, border: “none”, cursor: “pointer”, background: tab === i ? “linear-gradient(135deg,#c4a050,#f0d080)” : “transparent”, color: tab === i ? “#050814” : “#7878a0” }}>{t}</button>
);
})}
</div>
{tab === 0 ? (
...
function Register() {
var _a = useState({ name: “”, email: “”, phone: “”, country: “”, referral: “”, risk: “”, broker: “”, consent: false });
var form = _a[0], setForm = _a[1];
...
var inputStyle = { width: “100%”, background: “rgba(255,255,255,0.04)”, border: “1px solid rgba(196,160,80,0.2)”, borderRadius: 8, padding: “14px 16px”, color: “#f0e8d0”, fontFamily: “‘DM Sans’, sans-serif”, fontSize: 14, outline: “none” };
var labelStyle = { fontFamily: “‘DM Sans’, sans-serif”, fontSize: 12, color: “#7878a0”, marginBottom: 6, display: “block”, letterSpacing: “0.05em”, textTransform: “uppercase” };
...
<input style={inputStyle} placeholder=“Your full name” value={form.name} onChange={function(e) { set(“name”, e.target.value); }} />
</div>
<div>
<label style={labelStyle}>Email Address</label>
<input style={inputStyle} type=“email” placeholder=“you@email.com” value={form.email} onChange={function(e) { set(“email”, e.target.value); }} />
</div>
</div>
<div style={{ display: “grid”, gridTemplateColumns: “1fr 1fr”, gap: 20, marginBottom: 20 }}>
<div>
<label style={labelStyle}>Phone / WhatsApp</label>
<input style={inputStyle} placeholder=”+234 …” value={form.phone} onChange={function(e) { set(“phone”, e.target.value); }} />
</div>
<div>
<label style={labelStyle}>Country</label>
<input style={inputStyle} placeholder=“Nigeria” value={form.country} onChange={function(e) { set(“country”, e.target.value); }} />
</div>
</div>
<div style={{ marginBottom: 20 }}>
<label style={labelStyle}>Referral ID (Required)</label>
<input style={inputStyle} placeholder=“Enter your referrer’s ID” value={form.referral} onChange={function(e) { set(“referral”, e.target.value); }} />
</div>
<div style={{ display: “grid”, gridTemplateColumns: “1fr 1fr”, gap: 20, marginBottom: 20 }}>
<div>
<label style={labelStyle}>Risk Tier</label>
<select style={Object.assign({}, inputStyle, { cursor: “pointer” })} value={form.risk} onChange={function(e) { set(“risk”, e.target.value); }}>
...
<select style={Object.assign({}, inputStyle, { cursor: “pointer” })} value={form.broker} onChange={function(e) { set(“broker”, e.target.value); }}>
...
<input type=“checkbox” id=“consent” checked={form.consent} onChange={function(e) { set(“consent”, e.target.checked); }} style={{ marginTop: 2, accentColor: “#c4a050”, width: 16, height: 16, flexShrink: 0, cursor: “pointer” }} />
...
<button
onClick={function() { if (form.name && form.email && form.referral && form.consent) setSubmitted(true); }}
...
return <div key={i} style={{ fontFamily: “‘DM Sans’, sans-serif”, fontSize: 13, color: “#505070” }}>{c}</div>;
})}
</div>
</div>
{[
...
return <a key={l} href=”#” style={{ fontFamily: “‘DM Sans’, sans-serif”, fontSize: 14, color: “#505070”, textDecoration: “none” }}>{l}</a>;
})}
</div>
</div>
);
