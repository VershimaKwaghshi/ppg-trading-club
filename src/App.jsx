      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 70 }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
            <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: 20, color: "#f0d080", letterSpacing: "0.05em", lineHeight: 1 }}>PPG</span>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 10, color: "#8080a0", letterSpacing: "0.2em", textTransform: "uppercase", marginTop: 2 }}>Trading Club</span>
          </div>
        </div>
        ...
        <div className={`nav-links ${menuOpen ? "open" : ""}`}>
          ...
          <a href="#register" onClick={() => setMenuOpen(false)} style={{ background: "linear-gradient(135deg,#c4a050,#f0d080)", color: "#050814", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 13, padding: "10px 20px", borderRadius: 6, textDecoration: "none", textAlign: "center" }}>Join Now</a>
        </div>
...
function Register() {
  ...
  return (
    <section id="register" style={{ padding: "80px 1rem", background: "#050814" }}>
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        <AnimatedSection>
          <div style={{ background: "rgba(255,255,255,0.01)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 16, padding: "32px 20px" }}>
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.85rem", fontWeight: 900, color: "#f0e8d0", marginBottom: 8 }}>Application Form</h2>
            ...
            {status.msg && (
              <div style={{
                background: status.type === "success" ? "rgba(74,222,128,0.05)" : "rgba(239,68,68,0.05)",
                border: `1px solid ${status.type === "success" ? "#4ade80" : "#ef4444"}`,
                color: status.type === "success" ? "#4ade80" : "#ef4444",
                borderRadius: 8, padding: "12px 14px", marginBottom: 20, fontFamily: "'DM Sans', sans-serif", fontSize: 13, lineHeight: 1.4
              }}>
                {status.msg}
              </div>
            )}
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Full Name *</label>
                <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} required style={{ width: "100%", background: "rgba(5,8,20,0.6)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }} />
              </div>
              <div className="form-row">
                <div style={{ flex: 1 }}>
                  <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Email Address *</label>
                  <input type="email" name="email" value={formData.email} onChange={handleChange} required style={{ width: "100%", background: "rgba(5,8,20,0.6)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }} />
                </div>
                <div style={{ flex: 1 }}>
                  <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Phone / WhatsApp *</label>
                  <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="e.g. +234..." required style={{ width: "100%", background: "rgba(5,8,20,0.6)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }} />
                </div>
              </div>
              <div className="form-row">
                <div style={{ flex: 1 }}>
                  <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Country</label>
                  <input type="text" name="country" value={formData.country} onChange={handleChange} style={{ width: "100%", background: "rgba(5,8,20,0.6)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }} />
                </div>
                <div style={{ flex: 1 }}>
                  <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Referral ID *</label>
                  <input type="text" name="referralId" value={formData.referralId} onChange={handleChange} placeholder="Required" required style={{ width: "100%", background: "rgba(5,8,20,0.6)", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }} />
                </div>
              </div>
              <div className="form-row">
                <div style={{ flex: 1 }}>
                  <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Preferred Risk Tier</label>
                  <select name="riskTier" value={formData.riskTier} onChange={handleChange} style={{ width: "100%", background: "#050814", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }}>
                    {RISK_TIERS.map((t) => <option key={t.pct} value={t.pct}>{t.pct} - {t.label}</option>)}
                  </select>
                </div>
                <div style={{ flex: 1 }}>
                  <label style={{ display: "block", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#b0a080", marginBottom: 6, textTransform: "uppercase" }}>Broker Preference</label>
                  <select name="broker" value={formData.broker} onChange={handleChange} style={{ width: "100%", background: "#050814", border: "1px solid rgba(196,160,80,0.15)", borderRadius: 6, padding: "10px 12px", color: "#f0e8d0", fontFamily: "'DM Sans', sans-serif", fontSize: 14 }}>
              ...
              <button type="submit" disabled={loading} style={{ marginTop: 8, background: "linear-gradient(135deg,#c4a050,#f0d080)", color: "#050814", border: "none", borderRadius: 6, padding: "14px", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 14, cursor: "pointer" }}>
