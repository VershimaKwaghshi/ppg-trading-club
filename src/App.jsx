...
var base = { background: ‘rgba(5,8,20,0.6)’, border: ‘1px solid rgba(196,160,80,0.15)’, color: ‘#f0e8d0’, fontFamily: ‘sans-serif’, fontSize: 14, borderRadius: 6, padding: ‘10px’, width: ‘100%’, outline: ‘none’ };
...
var navBg = (scrolled || menuOpen) ? ‘rgba(5,8,20,0.97)’ : ‘transparent’;
...
<span style={{ fontSize: 16 }}>warning</span>
...
<span style={{ color: ‘#c4a050’, fontSize: 14, fontWeight: 700 }}>v</span>
...
var form = useState({ fullName: ‘’, email: ‘’, phone: ‘’, country: ‘Nigeria’, referralId: ‘’, riskTier: ‘1%’, broker: ‘No Preference’ });
var setForm = form[1];
form = form[0];
var loading = useState(false);
var setLoading = loading[1];
loading = loading[0];
var status = useState({ type: ‘’, msg: ‘’ });
...
var field = { width: ‘100%’, background: ‘rgba(5,8,20,0.7)’, border: ‘1px solid rgba(196,160,80,0.15)’, borderRadius: 6, padding: ‘10px 12px’, color: ‘#f0e8d0’, fontFamily: ‘sans-serif’, fontSize: 14, outline: ‘none’ };
var label = { display: ‘block’, fontFamily: ‘sans-serif’, fontSize: 10, fontWeight: 700, color: ‘#b0a080’, marginBottom: 4, textTransform: ‘uppercase’, letterSpacing: ‘0.08em’ };
